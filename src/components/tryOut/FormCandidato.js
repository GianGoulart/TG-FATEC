                ...
                <div className="box-body">
                    <div className="row">
                        ...
                        <div className="form-group col-sm-3">
                            ...
                            <div className="input-group">
                                <input type="date"  className="form-control" min="01/01/1900" max="31/12/2099" id="dataNascimento" name="dataNascimento" ref={(input) => this.dataNascimento = input} placeholder="dd/mm/yyyy"/>
                            </div>
                        </div>
